...
import com.smartbt.vtsuite.vtams.client.gui.component.datasource.CardBrandDS;
...
//    private BaseTextItem idIStream;
    ...
    /*  Row 7*/
    private BaseSelectItem distributorCombo;
...
//        idIStream.setTextAlign( Alignment.LEFT );
        ...
        /* Row 7*/
        distributorCombo = new BaseSelectItem( 27, "distributor", "Distributor", "Select the distributor for this merchant.", DataSourceBuilder.getDistributorDS(), false );
        distributorCombo.setTextAlign( Alignment.LEFT );
        distributorCombo.setWidth( 115 );
...
//        idIStream.setKeyPressFilter( RegExp.VALID_TEXT_REG_EXP );
    ...
    public Record getRecord() {
        ...
        Utils.debug( "MerchantEditor -> getRecord() :: 2" );
        //Loading Address
...
//        record.setAttribute( "idIStream", idIStream.getValueAsString() );
        ...
        record.setAttribute( "distributor", distributorCombo.getSelectedRecord() != null ? distributorCombo.getSelectedRecord().getAttributeAsInt( "id" ) : distributorCombo.getValue() );
    ...
    public void loadRecord( Record record ) {
        ...
        distributorCombo.setValue( record.getAttributeAsInt( "distributor" ) );
