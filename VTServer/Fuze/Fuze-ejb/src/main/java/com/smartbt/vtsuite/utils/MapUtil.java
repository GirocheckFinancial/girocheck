...
public class MapUtil {
    ...
    public static String getStringValueFromMap(Map map, ParameterName requestParameterName, boolean required)throws Exception{
        if(map.containsKey(requestParameterName)){
            if(map.get(requestParameterName) == null || map.get(requestParameterName).toString().equals(""))
                throw new Exception(requestParameterName.toString() + " Can Not be null for transaction: "+ getTType( map));
