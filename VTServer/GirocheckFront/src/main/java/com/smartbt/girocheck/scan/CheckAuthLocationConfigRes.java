...
public class CheckAuthLocationConfigRes extends MainResponseContainer implements IBuilder {
    ...
    public CheckAuthLocationConfigRes build(Map map) throws Exception {
        ...
        setParam1(MapUtil.getStringValueFromMap( map, ParameterName.PARAM1));
        setParam2(MapUtil.getStringValueFromMap( map, ParameterName.PARAM2));
        setParam3(MapUtil.getStringValueFromMap( map, ParameterName.PARAM3));
        setParam4(MapUtil.getStringValueFromMap( map, ParameterName.PARAM4));
