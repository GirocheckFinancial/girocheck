...
public class Scan {
     ...
     public PersonalInfoRes personalInfo( PersonalInfoRequest arg0 ) throws Exception {
         ...
         CustomeLogger.Output(CustomeLogger.OutputStates.Info, "[IStreamFront Scan] personalInfo",null);
         
         CustomeLogger.Output(CustomeLogger.OutputStates.Debug, "[IStreamFront Scan] feeAmount: "+arg0.getFeeAmount(),null);
