...
/**
 * <p>
 * Java class for cardReloadRequest complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="cardReloadRequest">
 *   &lt;complexContent>
...
@XmlType(name = "cardReloadRequest", propOrder = {
    "user",
    "password",
    "requestId",
    "terminalId",
...
public class CardReloadRequest implements IMap {
    ...
    public Map toMap() {
        ...
        map.put(TransactionType.TRANSACTION_TYPE, TransactionType.CARD_RELOAD);
