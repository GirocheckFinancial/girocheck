...
public class MapUtil {
    ...
    public static String getStringValueFromMap(Map map, ParameterName requestParameterName)throws Exception{
        return  getStringValueFromMap( map, requestParameterName, false);
    }
