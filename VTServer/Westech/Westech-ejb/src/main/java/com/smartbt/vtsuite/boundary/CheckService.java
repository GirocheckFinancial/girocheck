 ...
 * 
 */
@WebServiceClient(name = "CheckService", targetNamespace = "http://10.10.1.168/eFraudAPI", wsdlLocation = "http://61.12.87.130/eFraudAPI/CheckService.asmx?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CHECKSERVICE_QNAME = new QName("http://10.10.1.168/eFraudAPI", "CheckService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://61.12.87.130/eFraudAPI/CheckService.asmx?WSDL");
    ...
    public CheckServiceSoap getCheckServiceSoap() {
        return super.getPort(new QName("http://10.10.1.168/eFraudAPI", "CheckServiceSoap"), CheckServiceSoap.class);
    }
    ...
    public CheckServiceSoap getCheckServiceSoap12() {
        return super.getPort(new QName("http://10.10.1.168/eFraudAPI", "CheckServiceSoap12"), CheckServiceSoap.class);
    }
