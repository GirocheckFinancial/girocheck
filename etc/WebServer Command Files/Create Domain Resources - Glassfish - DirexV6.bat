...
SET dbResourceName=jdbc/girocheck
...
SET dbDestQueueCoreReply2=jms/DirexQueueCore2Out
SET dbDestQueueCoreRequest2=jms/DirexQueueCore2In
SET dbDestQueueHostReply=jms/DirexQueueHostOut
SET dbDestQueueHostRequest=jms/DirexQueueHostIn
SET dbDestQueueIstreamFrontReply=jms/DirexQueueFrontIStreamOut
SET dbDestQueueIstreamFrontRequest=jms/DirexQueueFrontIStreamIn

  
SET HIBERNATE_CON_PASSWORD=direxdb
SET HIBERNATE_CON_URL='jdbc:mysql://miadev.warp68.net:13306/girocheck'
...
CALL ASADMIN --port %domainPortNumber% --user admin --passwordfile %domainPassPath% create-jms-resource --restype %dbDestQueueType% %dbDestQueueCoreReply2%
CALL ASADMIN --port %domainPortNumber% --user admin --passwordfile %domainPassPath% create-jms-resource --restype %dbDestQueueType% %dbDestQueueCoreRequest2%
...
CALL ASADMIN --port %domainPortNumber% --user admin --passwordfile %domainPassPath% create-jms-resource --restype %dbDestQueueType% %dbDestQueueIstreamFrontReply%
CALL ASADMIN --port %domainPortNumber% --user admin --passwordfile %domainPassPath% create-jms-resource --restype %dbDestQueueType% %dbDestQueueIstreamFrontRequest%
